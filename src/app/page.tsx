  ...
  return (
    ...
    */}
      ...
      <a
        ...
        className="fixed right-5 top-5 z-10 inline-flex h-12 overflow-hidden rounded-full p-[1px] focus:outline-none focus:ring-2 focus:ring-slate-400 focus:ring-offset-2 focus:ring-offset-slate-50 "
      >
        <span className="absolute inset-[-1000%] animate-[spin_2s_linear_infinite] bg-[conic-gradient(from_90deg_at_50%_50%,#E2CBFF_0%,#393BB2_50%,#E2CBFF_100%)]" />
        <span className="inline-flex h-full w-full cursor-pointer items-center justify-center rounded-full bg-slate-950 px-3 py-1 text-sm font-medium text-white backdrop-blur-3xl">
          <svg
        ...
        <TracingBeam className=" h-auto">
          <div className="relative mx-auto max-w-2xl pt-4 antialiased">
            <div id="home" className="mb-10">
              <div className="bg-whte flex h-[40rem] w-full flex-col items-center justify-center overflow-hidden rounded-md">
